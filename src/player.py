...
player_keys = ["id", "league_id", "league_name", "team_id", "team_name", "name", "firstname", "lastname", "position", "age", "birth_date", "nationality", "flag", "height", "weight", "rating", "captain", "shots", "shots_on", "shots_on_pct", "goals", "goals_conceded", "assists", "passes", "passes_key", "passes_accuracy", "tackles", "blocks", "interceptions", "duels", "duels_won", "duels_won_pct", "dribbles_past", "dribbles_attempted", "dribbles_succeeded", "dribbles_succeeded_pct", "fouls_drawn", "fouls_committed", "cards_yellow", "cards_red", "cards_second_yellow", "cards_straight_red", "penalties_won", "penalties_committed", "penalties_scored", "penalties_missed", "penalties_scored_pct", "penalties_saved", "minutes_played", "games_appearances", "games_started", "games_bench", "substitutions_in", "substitutions_out"]
...
def player_team_data(player_id):
    ...
    return player_data_dict, team_data_dict, league_data_dict
